...
public class CreateUnicornFunction implements RequestStreamHandler {

    private static final Logger logger = LoggerFactory.getLogger(CreateUnicornFunction.class);
    private CreateUnicorn port;

    public CreateUnicornFunction() throws ExecutionException, InterruptedException {
        ...
        port = new AWSCreateUnicorn(dynamoDbClient, table, eventBridgeClient, eventBus);
    }
    ...
    public void handleRequest(InputStream inputStream, OutputStream outputStream, Context context) throws IOException {
        ...
        Unicorn unicorn = port.createUnicorn(newUnicorn);
        logger.info("Unicorn created: " + unicorn);
